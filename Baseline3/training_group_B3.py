...
from .eval_group_B3 import evaluate_group_B3



def train_group_one_epoch( model, train_loader, criterion, optimizer, device):
...
def train_group_B3(
    ...
    for epoch in range(epochs):
        ...
        train_loss, train_metrics = train_group_one_epoch(
            model,
            train_loader,
            criterion,
            optimizer,
        ...
        val_loss, val_metrics = evaluate_group_B3(
            model,
            val_loader,
            criterion,
            device
