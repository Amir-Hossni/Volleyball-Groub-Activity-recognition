...
from Baseline5.model_B5 import GroupTemporalClassifierB5 , GroupTemporalClassifierB5V2, PersonTemporalB5 
...
model = GroupTemporalClassifierB5V2(person_model=model_B5_stage1, num_classes=8)
